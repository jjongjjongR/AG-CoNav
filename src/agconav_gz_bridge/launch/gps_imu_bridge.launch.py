...
def generate_launch_description():
    ...
    # 1. leg와 wheel의 YAML 설정 파일 경로 각각 지정
    leg_config = os.path.join(pkg_dir, 'config', 'leg_sensors_bridge.yaml')
    wheel_config = os.path.join(pkg_dir, 'config', 'wheel_sensors_bridge.yaml')
